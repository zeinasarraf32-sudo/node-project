...
const ACTIONS = [
  { label: 'AI Assistant', icon: Brain, bg: 'bg-blue-50', text: 'text-blue-600' },
  { label: 'Book Appointment', icon: Calendar, bg: 'bg-emerald-50', text: 'text-emerald-600' },
  { label: 'My Appointments', icon: FileText, bg: 'bg-purple-50', text: 'text-purple-600' },
  { label: 'Prescriptions', icon: Pill, bg: 'bg-amber-50', text: 'text-amber-600' },
];
